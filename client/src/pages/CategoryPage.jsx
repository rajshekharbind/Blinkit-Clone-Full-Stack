...
const CategoryPage = () => {
  ...
  return (
    <section className=''>
        <div className='p-2   bg-white shadow-md flex items-center justify-between mt-6'>
            <h2 className='font-semibold'>Category</h2>
            <button onClick={()=>setOpenUploadCategory(true)} className='text-sm border border-yellow-400 hover:bg-orange-400 px-3 py-1 rounded'>Add Category</button>
        </div>
        {
...
//          categoryData.map((category,index)=>{
//             return(
//                <div className='w-42 h-56 object-scale-down rounded shadow-sm' key={category._id}>
//                   <img 
